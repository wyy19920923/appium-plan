...
//		BaseUtils.saveScreenshot(driver, caseId, "NormalLogin_Step1");
//		if (BaseUtils.waitForElementVisibility(driverWait, fastLoginTitleText)) {
...
//		}
	...
	public void checkLoginSuccess(String caseId) {
